defmodule Wizard.Integer do
  ...
  @doc """
  The Kernel function `is_integer` returns TRUE
  if the argument it receives is an integer.

  The Kernel function `is_float` returns TRUE
  if the argument it receives is a float.
  """
  def check(value) do
